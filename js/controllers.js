...
function MainCtrl($scope,$http) {
    ...
    $scope.movieSearchScroll = 0;
    $scope.backMovie = function(){
        $scope.movieSearchScroll = $scope.movieSearchScroll-1;
        url = 'API/allmovieList.php?startLimit='+$scope.movieSearchScroll+'';
        console.log(url);
        Http.open("GET", url);
        ...
        if (Http.readyState == 4 && Http.status == 200) {
            ...
            $("#movieList").append( "<p>back</p>" );
        }
        };
    };
    $scope.forwardMovie = function(){

        $scope.movieSearchScroll = $scope.movieSearchScroll+1;
        alert($scope.movieSearchScroll);
        ...
        if (Http.readyState == 4 && Http.status == 200) {
            console.log(JSON.parse(Http.responseText));
            data = JSON.parse(Http.responseText);
            $scope.movieList = data[0];
            $scope.$apply();
            console.log(data);
            $( "#movieList" ).append( "<p>Test</p>" );
